...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StretchNebiusNodeClass) DeepCopyInto(out *StretchNebiusNodeClass) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StretchNebiusNodeClass.
func (in *StretchNebiusNodeClass) DeepCopy() *StretchNebiusNodeClass {
	if in == nil {
		return nil
	}
	out := new(StretchNebiusNodeClass)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *StretchNebiusNodeClass) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StretchNebiusNodeClassList) DeepCopyInto(out *StretchNebiusNodeClassList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]StretchNebiusNodeClass, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StretchNebiusNodeClassList.
func (in *StretchNebiusNodeClassList) DeepCopy() *StretchNebiusNodeClassList {
	if in == nil {
		return nil
	}
	out := new(StretchNebiusNodeClassList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *StretchNebiusNodeClassList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StretchNebiusNodeClassSpec) DeepCopyInto(out *StretchNebiusNodeClassSpec) {
	*out = *in
	if in.OSDiskSizeGB != nil {
		in, out := &in.OSDiskSizeGB, &out.OSDiskSizeGB
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StretchNebiusNodeClassSpec.
func (in *StretchNebiusNodeClassSpec) DeepCopy() *StretchNebiusNodeClassSpec {
	if in == nil {
		return nil
	}
	out := new(StretchNebiusNodeClassSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StretchNebiusNodeClassStatus) DeepCopyInto(out *StretchNebiusNodeClassStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]status.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StretchNebiusNodeClassStatus.
func (in *StretchNebiusNodeClassStatus) DeepCopy() *StretchNebiusNodeClassStatus {
	if in == nil {
		return nil
	}
	out := new(StretchNebiusNodeClassStatus)
	in.DeepCopyInto(out)
	return out
}
